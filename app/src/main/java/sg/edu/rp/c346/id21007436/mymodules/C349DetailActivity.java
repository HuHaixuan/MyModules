...
public class C349DetailActivity extends AppCompatActivity {
    TextView tvDetails;
    Button btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c349_detail);

        tvDetails = findViewById(R.id.textView2);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(C349DetailActivity.this, MainActivity.class);
